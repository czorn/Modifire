...
def ThreadedUpdate(self, blocks, blockTexture, x, y, z):
    ...
    ChunkOfBlocks.ReplaceGeom(self, geom)
...
#        taskMgr.setupTaskChain('ChunkUpdate', numThreads = 1,
#                       frameSync = False)
#        taskMgr.add(ThreadedUpdate, 'ChunkUpdate1', taskChain = 'ChunkUpdate', extraArgs=[self, self.blocks, self.blockTexture, self.x, self.y, self.z])
        self.dirty = 0    
        #taskMgr.doMethodLater(1, self.ReplaceGeom, 'ReplaceGeom', extraArgs=[None])
